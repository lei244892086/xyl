...
<head>
    ...
    <title>韩国直购精品馆</title>
    <link rel="stylesheet" href="./common/css/styleinitialize.css">
    <link rel="stylesheet" href="./common/css/home.css">
    <link rel="stylesheet" href="./common/css/lunbo.css">
...
<div class="wrap">
    <div class="home-top">
        <div class="home-top-scan ">
            <img src="./common/imgs/sao-ma.png" alt="">
        </div>
        <form class="home-top-seek ">
            <div class="input">
                <input type="text">
                <div class="f_right">
                    <img src="./common/imgs/search.png" alt="">
                </div>

            </div>
            <div class="home-top-register">
                <a href="">登陆</a>
            </div>
        </form>
    ...
    <div class="home-download">
        <img src="./common/imgs/download.jpg" alt="">
    </div>
    <div class="home-focusimg">
        <div class="wrapper">
            ...
            <div class="aui-banner-content " data-aui-slider>
                <div class="aui-banner-wrapper">
                    <div class="aui-banner-wrapper-item">
                        <a href="#">
                            <img src="./common/imgs/focusimg1.jpg" alt="">
                        </a>
                    </div>
                    <div class="aui-banner-wrapper-item">
                        <a href="#">
    ...
    <div class="home-viefor">
        <img src="./common/imgs/vie-for.jpg" alt="">
    </div>
    <div class="home-popularity">
        <img src="./common/imgs/popularity.jpg" alt="">
    </div>
    <div class="home-newproduct">
        <img src="./common/imgs/brand%20new%20goods.png" alt="">
    </div>
    <div class="home-nav clearfix">
        <div class="home-nav-l f_left">
            <img src="./common/imgs/beauty%20goods.png" alt="">
        </div>
        <div class="home-nav-r f_right">
            <div class="home-nav-r1 f_left">
                <img src="./common/imgs/foods.png" alt="">
            </div>
            <div class="home-nav-r2 f_right">
                <img src="./common/imgs/healthy.png" alt="">
            </div>
            <div class="home-nav-r3 f_right">
                <img src="./common/imgs/service.png" alt="">
            </div>
        </div>
    </div>
    <div class="home-brand">
        <div class="home-brand-top">
            <img src="./common/imgs/brands.png"lt="">
        </div>
    ...
    <div class="home-serve">
        <img src="./common/imgs/tittle.png" alt="">
    </div>
</div>
<?
